...
execute as @e[type=interaction,tag=trash_interaction_chip_bag] on target run give @s paper[item_name="Chip Bag",item_model="cleanup:chip_bag",lore=["Trash"]]
execute as @e[type=interaction,tag=trash_interaction_balloon] on target run give @s paper[item_name="Balloon",item_model="cleanup:balloon",lore=["Trash"]]
